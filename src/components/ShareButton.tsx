// Social Share Component - Share statistics and info
...
const ShareButton = ({
  title = "HMObility - Seguridad Vial Hermosillo",
  text = "Consulta información sobre tránsito y seguridad vial en Hermosillo",
